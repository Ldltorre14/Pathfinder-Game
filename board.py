...
class GameBoard:
    def __init__(self, screen):
        ...
        self.grid = [[Tile((x * (self.tile_size + self.margin)) + self.margin, ((y * (self.tile_size + self.margin)) + self.margin) + 235 , self.tile_size, self.tile_size, (255,255,255), False,False,False) for y in range(self.grid_height)] for x in range(self.grid_width)]
